<html>
  ...
  <body>
    <button id="replayer-button" type="button"
            onclick="playDemoRecording(false)">
    ...
    <a-scene>
      ...
      <a-locomotor>
        <a-entity id="lhand" hand-controls="left" super-hands
                  sphere-collider="objects: a-link">
        </a-entity>
        <a-entity id="rhand" hand-controls="right" super-hands
                  sphere-collider="objects: a-link">
        </a-entity>
      </a-locomotor>
      <a-entity a-painter-loader="src: https://ucarecdn.com/e1fb7084-88d3-4c0c-bbec-ab43b4d88722/"
       rotation="0 90 0" scale="15 15 15" position="0 -1.4 0">
      </a-entity>
      <!-- <a-entity a-painter-loader="src:https://ucarecdn.com/bc781073-b16a-4513-86e3-0171e5972bce/"
