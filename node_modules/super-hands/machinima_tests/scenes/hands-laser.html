    ...
    <a-scene avatar-recorder="spectatorPlay: true; spectatorPosition: 0 1.6 2">
      <a-assets>
        <a-mixin id="controller"
                 super-hands="colliderEvent: mouseenter;
        ...
        <a-mixin id="cube-grabbed" material="opacity: 0.7; transparent: true">
        </a-mixin>
        <a-mixin id="cube-dragover" material="wireframe: true;"></a-mixin>
      </a-assets>
      <!-- <a-entity id="lhand" laser-controls="hand: left" mixin="controller"></a-entity> -->
      <a-entity id="rhand" laser-controls="hand: right" mixin="controller"></a-entity>
