  ...
  <body>
    <a-scene physics="debug: true" environment="preset: contact; shadow: true">
      <a-assets>
        ...
        <a-mixin id="bat-hovered" material="opacity: 0.7; transparent: true"></a-mixin>
        <a-mixin id="ball-hovered" material="opacity: 0.7; transparent: true"></a-mixin>
        <a-mixin id="bat-stretched" material="wireframe: true"></a-mixin>
        <img id="portals-preview" src="../assets/portals.jpg"></img>
      </a-assets>
      <a-locomotor allow-scaling="false"
